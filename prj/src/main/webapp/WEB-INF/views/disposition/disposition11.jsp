		...
		<div align="center">
			...
			<div class="answer1">
				<input type="button" class="A" value="${dto.disposition_answer1 }"
					onclick="location.href='dispositionC_1_1.do?id=<%=userId%>&no=12'">
			</div>
			<br> <br>

			<div class="answer2">
				<input type="button" class="A" value="${dto.disposition_answer2 }"
					onclick="location.href='dispositionC_1_2.do?id=<%=userId%>&no=12'">
			</div>
			<br> <br>

			<div class="answer3">
				<input type="button" class="A" value="${dto.disposition_answer3 }"
					onclick="location.href='dispositionC_1_3.do?id=<%=userId%>&no=12'">
			</div>
			<br> <br>
