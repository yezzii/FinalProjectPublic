		...
		<div align="center">
			...
			<div class="answer1">
				<input type="button" class="A" value="${dto.disposition_answer1 }"
					onclick="location.href='dispositionB_3_1.do?id=<%=userId%>&no=9'">
			</div>
			<br> <br>

			<div class="answer2">
				<input type="button" class="A" value="${dto.disposition_answer2 }"
					onclick="location.href='dispositionB_3_2.do?id=<%=userId%>&no=9'">
			</div>
			<br> <br>

			<div class="answer3">
				<input type="button" class="A" value="${dto.disposition_answer3 }"
					onclick="location.href='dispositionB_3_3.do?id=<%=userId%>&no=9'">
			</div>
			<br> <br>
