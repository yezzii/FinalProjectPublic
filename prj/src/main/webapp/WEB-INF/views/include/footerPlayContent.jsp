...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/footer4.css"/>
...
<body>
	...
	<div id="popup">
		...
		<span class="popup-clock">00:00:00</span>&nbsp;
		<span>/</span>&nbsp;
		<span class="popup-temp"></span><br> <span class="precipitation"></span><br>
		<div class="air-ment-div">
		...
		<div class="footer_wrap">
			...
			<div class="footer_right">
				...
				<div class="inner_div end">
					...
					<div class="inner_content">
						<ul class="inner_ul">
							<li class="inner_li team_info">KO KANGCHAN&nbsp;&nbsp;|&nbsp;&nbsp;bushwick97@naver.com</li>
	...
	<script src="./resources/js/scrollContent.js"></script>
</body>
</html>