...
<body>
	...
	<div class="find-pwd-con" align="center">

		<form method="post"
			action="<%=request.getContextPath()%>/member_findId.do">
			<div>등록한 이메일로 아이디 찾기<br>본인확인 이메일 주소와 입력한 이메일 주소가 같아야, 인증번호를 받을 수
			있습니다.</div>
			...
			<div class="mail-check-box-con">
				...
				<br>
				<span id="mail-check-warn"></span> <input type="submit"
					id="signup-btn" value="아이디 찾기">
			</div>
		</form>
	</div>
