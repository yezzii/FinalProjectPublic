...
<body>
			...
			<div class="form-wrap">
				<div class="left-right-id-con">
					<div class="id-left-con">
						...
						<input class="input-width" name="id" id="id" minlength="5"
							maxlength="20" placeholder="영문 대소문자, 숫자  5~20자" required>
						<div id="checkId"></div>
						<div>비밀번호</div>
						<input class="input-width" type="password" name="password"
							id="password" minlength="8" maxlength="16"
							placeholder="영문 대소문자, 숫자, 특수문자를 하나 이상 포함하여 8~16자" required>
						<div id="pwd"></div>

						<div>비밀번호 확인</div>
						<input class="input-width" type="password" name="password_check"
							id="passwordCheck" minlength="8" maxlength="16" required>
						<div id="checkPwd"></div>

						<div>이름</div>
						<input class="input-width" name="name" id="name" minlength="2"
							maxlength="6" placeholder="2~6글자의 한글" required>
						<div id="checkName"></div>

						<div>닉네임</div>
						<input class="input-width" name="nick_name" id="nick_name"
							placeholder="한글과 영어, 숫자만 사용 2~10글자" minlength="2" maxlength="10"
							required>
					...
					<div class="id-right-con">
						<br> <br>
						<div>이메일</div>
						<input class="input-width" type="email" name="email" id="email"
							placeholder="ex)aa01@aa.aa" required>
						...
						<input class="input-width" name="phone" id="phone"
							placeholder="ex.) 01012341234" maxlength="11" required>
	...
	<script src="./resources/js/member_insert.js"></script>
</body>
</html>