...
<c:set var="list" value="${memberReplyContentList}" />
									...
									<c:forEach items="${list }" var="dto">
										<tr>
											...
											<c:if test="${!empty ManagerId }">
												<td><a
													href="<%=request.getContextPath() %>/manager_look_user_info_view.do?user_nick_name=${dto.community_writer}">${dto.community_writer }</a></td>
											</c:if>
											<c:if test="${empty ManagerId }">
												<td><a
													href="<%=request.getContextPath() %>/member_profile_view.do?user_nick_name=${dto.community_writer}">${dto.community_writer }</a></td>
											</c:if>
											<td><c:if
